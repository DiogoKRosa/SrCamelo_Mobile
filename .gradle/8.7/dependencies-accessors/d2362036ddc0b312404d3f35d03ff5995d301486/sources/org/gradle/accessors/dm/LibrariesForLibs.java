...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class ComSquareupRetrofit2LibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>com.squareup.retrofit2.converter</b>
         */
        public ComSquareupRetrofit2ConverterLibraryAccessors getConverter() {
            return laccForComSquareupRetrofit2ConverterLibraryAccessors;
        }
    ...
    public static class ComSquareupRetrofit2ConverterLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public Provider<MinimalExternalModuleDependency> getGson() {
            return create("com.squareup.retrofit2.converter.gson");
        }
    ...
    public static class IdentityLibraryAccessors extends SubDependencyFactory {
        private final IdentityDoctypesLibraryAccessors laccForIdentityDoctypesLibraryAccessors = new IdentityDoctypesLibraryAccessors(owner);

        public IdentityLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>identity.doctypes</b>
         */
        public IdentityDoctypesLibraryAccessors getDoctypes() {
            return laccForIdentityDoctypesLibraryAccessors;
        }

    }

    public static class IdentityDoctypesLibraryAccessors extends SubDependencyFactory {

        public IdentityDoctypesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>jvm</b> with <b>com.android.identity:identity-doctypes-jvm</b> coordinates and
         * with version reference <b>identityDoctypesJvm</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getJvm() {
            return create("identity.doctypes.jvm");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coroutinesAndroid</b> with value <b>1.7.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>identityDoctypesJvm</b> with value <b>202411.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getIdentityDoctypesJvm() { return getVersion("identityDoctypesJvm"); }
        ...
        /**
         * Version alias <b>materialIconsExtended</b> with value <b>1.7.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>roomCompiler</b> with value <b>2.4.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>roomRuntime</b> with value <b>2.4.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
